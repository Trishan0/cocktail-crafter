...
import { getPumps, getIngredients, assignPump, updatePumpFlowRate, updatePumpInventory } from "@/lib/api";
          ...
          <div className="grid gap-6 py-4">
            <div className="grid gap-2">
              ...
              <Select value={assignId} onValueChange={setAssignId}>
                ...
                <SelectContent>
                  {selectedPump?.pump_number !== 1 && <SelectItem value="none">None (Unassigned)</SelectItem>}
                  {ingredients.filter(l => selectedPump?.pump_number !== 1 || l.name.trim().toLowerCase() === "water").map(l => (
